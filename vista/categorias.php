			...
			<div class="card-body">
				<div class="row">
					...
					<div class="col-md-4">
						...
						<button type="button" class="btn btn-success" onclick="openModalCategoria()"><i class="fa fa-plus"></i> Nuevo</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-between">
				...
				<button type="button" class="btn btn-success" onclick="registrarCategoria()"><i class="fa fa-save"></i> Registrar</button>
			</div>
		</div>
		<!-- /.modal-content -->
	</div>
